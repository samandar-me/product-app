package com.sdk.cleanarchwithjetpackcompose.domain.login.use_case
...
class LoginUseCase @Inject constructor(
    ...
    suspend operator fun invoke(loginRequest: LoginRequest): Flow<BaseResult<LoginEntity, WrapperResponse<LoginResponse>>> {
